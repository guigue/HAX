...
//static const char     SOCKET_ADC_UDP_IP[]	= { "192.168.1.100" };	// My notebook IP (SP)
static const char     SOCKET_ADC_UDP_IP[]	= { "192.168.1.101" };	// My notebook IP (SP)
static const uint16_t SOCKET_ADC_UDP_PORT   = 15000;				// My notebook PORT

//static const char     SOCKET_ADC_TCP_IP[]	= { "192.168.1.100" };	// My notebook IP (SP)
static const char     SOCKET_ADC_TCP_IP[]	= { "192.168.1.101" };	// My notebook IP (SP)
static const uint16_t SOCKET_ADC_TCP_PORT   = 15001;				// My notebook PORT


//static const char     SOCKET_SNTP_IP[]	= { "192.168.1.100" };	// My notebook IP (SP)
static const char     SOCKET_SNTP_IP[]	= { "192.168.1.101" };	// My notebook IP (SP)
