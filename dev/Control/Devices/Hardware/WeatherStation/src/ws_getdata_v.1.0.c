/*
        ...
        Weather Station Get Data version 1.0.0
*/
...
/*
	...
	--------------------------------------------------------------------------------
	  0.4.1 |  10-09-2024	| Separacao de rotinas "verbose" de rotinas para serem 
		...
		|		| Correção de todos os warnings, e teste de gravação.
      	--------------------------------------------------------------------------------
	  1.0	|  10-09-2024	| Primeira versão para produção, incluindo caminho do
	  	|		| diretorio de armazenamento dos dados. Remoção do kbhit() 
		|		| para um Do..while infinito.
...
static char * DATA_DIR = "/homs/HATS/data/aux";       //From config file - Specific
