...
******************** OPERATION MODES OF HATS MOVEMENT *************************

---- Based on SST code numbers
...
#define OPMODEEND	200	// Counter Index End
...
typedef struct
{
	int object	;	// Selected Object or Target
	int opmode	;	// Operation Mode of telescope
} opmode_data_type ;
