...
/*
	...
	---------------------------------------------------------------------------------	
	  0.4	|  27-20-2021	| Modificacoes nas linhas a partir da 920 para modificar
	...
	---------------------------------------------------------------------------------
	  0.4.1 |  30-3-2022	| Modificacao no arquivo de log para facilitar a correlacao
	  			  dos dados do sensor com os parametros introduzidos.
	_________________________________________________________________________________
