/*
	...
	---------------------------------------------------------------------------------
	  ...
	  0.6.4 |  01-10-2021	| Revisao da aplicacao dos modos de operacao (TRACK, 
		...
		|		|
	  0.6.5 |		| Implementacao --version, --debug e --v ou --verbose.
...
*/
	...
	if (!object || (memcmp(object,"PARK",4) == 0) || (memcmp(object,"UNPARK",6) == 0) || (memcmp(object,"CONNECT",7) == 0) || (memcmp(object,"DISCONNECT",10) == 0) || (memcmp(object,"HOME",4) == 0) || (memcmp(object,"STALL",5) == 0) || (memcmp(object,"sky",3) == 0))
	{
		...
		if (connect_flag == 1 && park_flag == 1)
		{
			...
			printf("Slewing to Park position...\n\n");
		...
		if (sky_flag)
		{
			...
			printf("Target Sky data instructions sent to remote server.\n\n");
			
			printf("Slewing to sky offset position...\n\n");
		...
		if (stall_flag)
		{
			...
			printf("Stall data instructions sent to remote server.\n\n");
		...
		{ 
			printf("REPLY NOT UNDERSTANDABLE.\n\n");
...
*/
		...
		printf("Stall instructions sent to remote server.\n");
		...
		printf("Stall reply received from socket server.\n");
