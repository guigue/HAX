...
/*
	...
	--------------------------------------------------------------------------------       	
	  0.6.3	|  27-10-2021	| Implementacao de gravacao rotativa de arquivos a
		...
		|		| estabilizaram.
	--------------------------------------------------------------------------------
	  0.6.4 | 		| Implementacao de DAEMON para execucao em background
  				  com rotina para finalizacao segura apos o recebimento
				  de um KILL ou sinal TERMINATE.	  
...
void ReadMount( int sig )
{
	...
	//	if ( (fd_data_w = write(fd_data , wbpos_ptr , WB_ByteSize)) < WB_ByteSize)
	//	{
